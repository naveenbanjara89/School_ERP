...
const contentData = [
  { id: 1, title: "Physics Chapter 3 Notes", type: "PDF", category: "Study Material", sharedWith: "Class 10", uploadedBy: "Mr. Rajesh Kumar", date: "2025-02-10", size: "2.4 MB", downloads: 85 },
  { id: 2, title: "Annual Day Event Photos", type: "Image", category: "Gallery", sharedWith: "All Classes", uploadedBy: "Admin", date: "2025-02-09", size: "15.6 MB", downloads: 142 },
  { id: 3, title: "Mathematics Formula Sheet", type: "PDF", category: "Study Material", sharedWith: "Class 9, 10", uploadedBy: "Mrs. Priya Sharma", date: "2025-02-08", size: "1.1 MB", downloads: 210 },
  { id: 4, title: "Science Lab Safety Video", type: "Video", category: "Tutorial", sharedWith: "Class 8, 9, 10", uploadedBy: "Dr. Suresh Patel", date: "2025-02-07", size: "45.2 MB", downloads: 67 },
  { id: 5, title: "Exam Timetable Feb 2025", type: "PDF", category: "Notice", sharedWith: "All Classes", uploadedBy: "Admin", date: "2025-02-06", size: "0.5 MB", downloads: 320 },
  { id: 6, title: "Hindi Poetry Collection", type: "Document", category: "Study Material", sharedWith: "Class 7, 8", uploadedBy: "Mr. Deepak Singh", date: "2025-02-05", size: "3.2 MB", downloads: 45 },
];
...
const Page = () => {
  ...
  return (
    <AdminLayout>
        ...
        {showForm && (
            <Card>
            <CardHeader><CardTitle className="text-lg">Upload New Content</CardTitle></CardHeader>
            <CardContent>
